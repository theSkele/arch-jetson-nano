...
set RED "\x1b[1;31m"
set WHITE "\x1b[1;37m"
set YELLOW "\x1b[1;33m"
set RESET "\x1b[0m"

# Check if tarballs are already downloaded
if not test -f Jetson-210_Linux_R32.7.6_aarch64.tbz2
...
if not test -f ArchLinuxARM-aarch64-latest.tar.gz
    wget http://os.archlinuxarm.org/os/ArchLinuxARM-aarch64-latest.tar.gz
end

if test -d Linux_for_Tegra
...
mkdir -p Linux_for_Tegra/nv_tegra/nvidia_drivers Linux_for_Tegra/nv_tegra/config Linux_for_Tegra/nv_tegra/nv_tools Linux_for_Tegra/nv_tegra/nv_sample_apps/nvgstapps
